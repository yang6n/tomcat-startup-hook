 ...
 * files found in the "server" directory under "catalina.home"), and starts the regular execution of the container. The purpose of this roundabout approach is
 * to keep the Catalina internal classes (and any other classes they depend on, such as an XML parser) out of the system class path and therefore not visible to
...
public final class Bootstrap {
     ...
     * 
     */
    private static final String STARTUP_CLASS = "com.estudio.tomcat.startup.Catalina";
    ...
    public void init() throws Exception {
        ...
        Class<?> startupClass = catalinaLoader.loadClass(STARTUP_CLASS);
    ...
    private void setCatalinaBase() {
        ...
        if (System.getProperty(Globals.CATALINA_BASE_PROP) != null) return;
        if (System.getProperty(Globals.CATALINA_HOME_PROP) != null) System.setProperty(Globals.CATALINA_BASE_PROP, System.getProperty(Globals.CATALINA_HOME_PROP));
        else System.setProperty(Globals.CATALINA_BASE_PROP, System.getProperty("user.dir"));
    ...
    private void setCatalinaHome() {
        ...
        if (System.getProperty(Globals.CATALINA_HOME_PROP) != null) return;
